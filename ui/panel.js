...
(function () {
  ...
  const VIS_NAMES = { clock: '世界时间', background: '世界背景', people: '人物', currents: '暗流', echoes: '回声', memory: '记忆', opinion: '舆情', pulse: '世界脉搏', ledger: '重大事件账本', digest: '世界推演', style: '叙事工艺',
    ...
    appearance: '外貌契约', ladder: '原型阶梯', sceneSlice: '情境切片', gauge: '阻尼量规', rivalry: '竞争焦点', enigma: '信息暗礁', tempo: '节奏齿轮', quota: '伏笔配给', spotlight: '焦点分配', karma: '业力双轴', hazard: '累积风险', marginal: '边际折旧', tolerance: '手段耐受', events: '事件调度' };
